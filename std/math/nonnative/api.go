...
func NewBuilder(newBuilder frontend.NewBuilder, params *Params) frontend.NewBuilder {
	return func(mod *big.Int, cc frontend.CompileConfig) (frontend.Builder, error) {
		nativeBuilder, err := newBuilder(mod, cc)
		if err != nil {
